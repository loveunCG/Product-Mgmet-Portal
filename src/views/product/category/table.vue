<template>
  <b-card>
    ...
    <b-button variant="primary" class="add_button float-right" v-show = "checkButton('category_add')"  v-on:click="onAddModal"><i class="fa fa-plus"></i></b-button>
    <b-table :hover="hover" :striped="striped" :bordered="bordered" :small="small" :busy.sync="isBusy"  responsive="sm" :items="items" :fields="fields" :current-page="currentPage" :per-page="perPage">
      <template slot="action" slot-scope="data">
        <b-button variant="success" v-show = "checkButton('category_edit')"  v-on:click="onEditModel(data.item.action)"><i class="fa fa-edit"></i></b-button>
        <b-button variant="danger" v-show = "checkButton('category_del')"  v-on:click="onDeleteModal(data.item.action)"><i class="fa fa-trash"></i></b-button>
      </template>
    </b-table>
    <nav>
